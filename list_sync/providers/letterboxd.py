...
def fetch_letterboxd_list(list_id: str) -> List[Dict[str, Any]]:
    ...
    try:
            ...
            while True:
                ...
                for item in items:
                    try:
                        ...
                        logging.warning(f"Failed to parse movie item: {e!s}")
                        continue
                ...
                try:
                    if is_watchlist:
                        ...
                        if has_next_page and next_button:
                            ...
                            try:
                                ...
                                logging.warning(f"Error clicking 'Older' button: {e!s}")
                    ...
                    logging.warning(f"Error checking pagination: {e!s}")
        ...
        logging.exception(f"Error fetching Letterboxd list: {e!s}")
        raise
